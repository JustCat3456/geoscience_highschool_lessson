...
exports.contentIterator = exports.implicitIterator = exports.relationIterator = exports.indexRadical = exports.closingRadical = exports.openingRadical = exports.hyperFractionBoundary = exports.overBevelledFraction = exports.overFraction = exports.closingFraction = exports.openingFraction = void 0;
...
function contentIterator(nodes, context) {
    var _a;
    let func = (0, store_util_js_1.contentIterator)(nodes, context);
    let parentNode = nodes[0].parentNode.parentNode;
    let match = (_a = parentNode.getAttribute('annotation')) === null || _a === void 0 ? void 0 : _a.match(/depth:(\d+)/);
    let depth = match ? match[1] : '';
    return function () {
